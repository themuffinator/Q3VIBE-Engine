...
- Vendored wrappers live under `subprojects/` and mirror the WORR-style dependency contract instead of hard-coding legacy engine paths in the root `meson.build`.
