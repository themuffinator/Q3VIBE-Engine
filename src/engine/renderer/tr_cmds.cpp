...
============
*/
static q_alloc_ptr_t R_GetCommandBufferReserved( int bytes, int reservedBytes ) {
	renderCommandList_t	*cmdList;
	...
	return Q_AllocPtr( cmdList->cmds + cmdList->used - bytes );
}
...
=============
*/
static q_alloc_ptr_t R_GetCommandBuffer( int bytes ) {
